    ...
    public static String getSubjectOrden(String contenido) {
        ...
        if (index > -1) {
            ...
            if ("HELP".equals(orden) || 
                    "OBTENERDOCENTES".equals(orden)  || 
                    "OBTENERADMINISTRADORES".equals(orden) ||
                    "OBTENERCLIENTES".equals(orden)||
                    "OBTENERCARGOS".equals(orden)  || 
                    "OBTENERPROFESIONES".equals(orden)  || 
                    "OBTENERPROGRAMAS".equals(orden)  || 
                    "OBTENERMODULOS".equals(orden)  || 
                    "OBTENERCONVALIDACIONES".equals(orden)  || 
                    "OBTENERBOLETASINSCRIPCIONES".equals(orden)  || 
                    "CERRARACTADENOTAS".equals(orden)  || 
                    "OBTENERNOTAS".equals(orden)  || 
                    "OBTENERPLANESPAGOS".equals(orden)  || 
                    "REPORTEUSUARIOS".equals(orden)  || 
                    "REPORTEGANANCIAS".equals(orden)  || 
                    "NOTIFICACIONES".equals(orden) ||
                    "OBTENEROFERTAPROGRAMAS".equals(orden)
