...
public class Helper {
    ...
    public static final String HELP_GLOBAL = "Bienvenido al Sistema de INEGAS\n\n"
            ...
            + "parametros: OBTENERDOCENTE [idid_docente]\n"
            + "\n"
            + "OBTENERDOCENTES \n" 
            ...
            + ">>>> Solo Administrador del Sistema\n"
            + "Modificar Docente \n"
            + "El comando que permite modificar un Docente es: MODIFICARDOCENTE \n"
            + "parametros: MODIFICARDOCENTE [id,nombre, apellido, ci, telefono, correo]\n"
            + "\n"
            + "ELIMINARDOCENTE \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Docente \n"
            + "El comando que permite Eliminar un Docente es: ELIMINARDOCENTE \n"
            + "parametros: ELIMINARDOCENTE [id_docente]\n"
            + "\n"
            //2
            ...
            + ">>>> Solo Administrador del Sistema\n"
            + "Modificar Administrador \n"
            + "El comando que permite modificar un Cargo es: MODIFICARCARGO \n"
            + "parametros: MODIFICARCARGO [id, nombre]\n"
            + "\n"
            + "ELIMINARCARGO \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Cargo \n"
            + "El comando que permite Eliminar un Cargo es: ELIMINARCARGO \n"
            + "parametros: ELIMINARCARGO [id_cargo]\n"
            + "\n"
            //5
            + "REGISTRARPROFESION \n" 
            + ">>>> Solo Administrador del Sistema\n"
            ...
            + ">>>> Solo Administrador del Sistema\n"
            + "Modificar Profesion \n"
            + "El comando que permite modificar una Profesion es: MODIFICARPROFESION \n"
            + "parametros: MODIFICARPROFESION [id, nombre]\n"
            + "\n"
            + "ELIMINARPROFESION \n"
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Profesion \n"
            + "El comando que permite Eliminar una Profesion es: ELIMINARPROFESION \n"
            + "parametros: ELIMINARPROFESION [id_profesion]\n"
            + "\n"
            //6
            + "REGISTRARPROGRAMA \n" 
            + ">>>> Solo Administrador del Sistema\n"
            ...
            + "\n"
            + "OBTENERPROFESIONESDOCENTE \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtener Profesiones del Docente \n"
            + "El comando que permite obtener un Listado de las profesiones de un Docente es: OBTENERPROFESIONESDOCENTE \n"
            + "parametros: OBTENERPROFESIONESDOCENTE [id_docente]\n"
            + "\n"
            + "ELIMINARPROFESIONDOCENTE \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Profesion de un Docente \n"
            + "El comando que permite Eliminar una Profesion de un Docente es: ELIMINARPROFESIONDOCENTE \n"
            + "parametros: ELIMINARPROFESIONDOCENTE [id]\n"
            + "\n"
            //9
            + "REGISTRARCARGOADMIN \n"
            + ">>>> Solo Administrador del Sistema\n"
            ...
            + "parametros: REGISTRARCARGOADMIN [id_administrador, id_cargo]\n"
            + "\n"
            + "OBTENERCARGOSADMIN \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtener Profesiones del Docente \n"
            + "El comando que permite obtener un Listado de las profesiones de un Docente es: OBTENERCARGOSADMIN \n"
            + "parametros: OBTENERCARGOSADMIN [id_administrador]\n"
            + "\n"
            + "ELIMINARCARGOADMIN \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Cargo de un Administrador\n"
            + "El comando que permite Eliminar un Cargo de un Administrador es: ELIMINARCARGOADMIN \n"
            + "parametros: ELIMINARCARGOADMIN [id]\n"
            + "\n"
            //10
            ...
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtener Convalidacion \n"
            + "El comando que permite obtener una Convalidacion es: OBTENERCONVALIDACION \n"
            + "parametros: OBTENERCONVALIDACION [id_convalidacion]\n"
            + "\n"
            + "OBTENERCONVALIDACIONES \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtenrer Convalidaciones \n"
            + "El comando que permite obtener todas las Convalidaciones es: OBTENERCONVALIDACIONES \n"
            + "parametros: OBTENERCONVALIDACIONES\n"
            + "\n"
            + "ELIMINARCONVALIDACION \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Convalidacion \n"
            + "El comando que permite elimminar una Convalidacion es: ELIMINARCONVALIDACION \n"
            + "parametros: ELIMINARCONVALIDACION [id_convalidacion]\n"
            + "\n"
            //13
            ...
            + ">>>> Solo Administrador del Sistema\n"
            + "Registrar Modulo Boleta \n"
            + "El comando que permite registrar la Asigancion de un Modulo a una Boleta de Inscripcion es: REGISTRARMODULOBOLETA \n"
            + "parametros: REGISTRARMODULOBOLETA [id_boletaInsccripcion, id_detalle_oferta_programa_detalle_programa_modulo]\n"
            //17
            + "CERRARACTADENOTAS \n"
            + ">>>> Solo Administrador del Sistema\n"
            + "Cerrar Acta de Notas\n"
            + "El comando que permite Cerrar el Acta de Notas es: CERRARACTADENOTAS \n"
            + "parametros: CERRARACTADENOTAS\n"
            //18
            + "OBTENERNOTA \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtener Nota Final de un Modulo\n"
            + "El comando que permite obtener la nota final de un Modulo es: OBTENERNOTA \n"
            + "parametros: OBTENERNOTA [id_boletInscripcion]\n"
            + "\n"
            + "OBTENERNOTAS \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtener todas las Notas Finales de todos los modulos\n"
            + "El comando que permite obtener las notas finales de todos los Modulos es: OBTENERNOTAS\n"
            + "parametros: OBTENERNOTAS\n"
            + "\n"
            + "ELIMINARNOTA \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Nota\n"
            + "El comando que permite eliminar una Nota de un Modulo es: ELIMINARNOTA \n"
            + "parametros: ELIMINARNOTA [id_boletaInscripcion]\n"
            + "\n"
            //19
            + "REGISTRARPLANPAGO \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Registrar Plan de Pago\n"
            + "El comando que permite registrar un Plan de Pago es: REGISTRARPLANPAGO \n"
            + "parametros: REGISTRARPLANPAGO [Fecha Inicio, Fecha Limite, Monto Total, ID Boleta Inscripcion]\n"
            + "\n"
            + "OBTENERPLANPAGO \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtener Plan de Pago\n"
            + "El comando que permite obtener un Plan de Pago es: OBTENERPLANPAGO \n"
            + "parametros: OBTENERPLANPAGO [id_planPago]\n"
            + "\n"
            + "OBTENERPLANESPAGOS \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtener todos los Planes de Pago\n"
            + "El comando que permite obtener todos los Planes de Pago es: OBTENERPLANESPAGOS\n"
            + "parametros: OBTENERPLANESPAGOS\n"
            + "\n"
            + "ELIMINARPLANPAGO \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Plan Pago\n"
            + "El comando que permite eliminar un Plan de Pago es: ELIMINARPLANPAGO \n"
            + "parametros: ELIMINARPLANPAGO [id_planPago]\n"
            + "\n"
            //20
            + "OBTENERCONVALIDACIONINFORME \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Obtener Informe de Convalidacion\n"
            + "El comando que permite obtener un Informe de Convalidacion es: OBTENERCONVALIDACIONINFORME \n"
            + "parametros: OBTENERCONVALIDACIONINFORME [id_convalidacion]\n"
            + "\n"
            + "ELIMINARCONVALIDACIONINFORME \n" 
            + ">>>> Solo Administrador del Sistema\n"
            + "Eliminar Infrome de Convalidacion\n"
            + "El comando que permite eliminar un Informe de Convalidacion es: ELIMINARCONVALIDACIONINFORME \n"
            + "parametros: ELIMINARCONVALIDACIONINFORME [id_informeConvalidacion]\n"
            + "\n"
            //21
            + "REPORTEUSUARIOS \n" 
            + ">>>> Solo Administrador del Sistema\n"
